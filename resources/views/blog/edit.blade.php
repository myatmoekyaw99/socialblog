...
<x-slot name="header">
    ...
    <form method="POST" action="{{route('blog.update',$blog->id)}}" class="card col-11 col-md-8 mx-auto p-5" enctype="multipart/form-data">
        ...
        <div class="mt-4" style="width: 90%;">
            ...
            <textarea id="bio" name="description" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" name="bio" required>{{$blog->description}}</textarea>
